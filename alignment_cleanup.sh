...
Help()
{
	...
	echo "		while read sample; do sbatch [options] $SCRIPTS/alignment_cleanup.sh -l $sample ; done < HC-batch-091324.txt"
	...
	echo "	   Like with the -l option, you will also need to loop through a text file if running a batch."
