...
# knitr::opts_knit$set(root.dir = params$myargs,warning=FALSE, message=FALSE, fig.pos = "H", out.extra = "")
...
#rundate <- format(Sys.time(), "%m%e%y") ##CHANGE BACK 
rundate <- "082324"
